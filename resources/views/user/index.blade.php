...
@if (session('update') == 'success')
    <x-alert type="success">
        <strong>Berhasil dibuat!</strong> User berhasil diupdate.
    </x-alert>
@endif
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        ...
                        <button type="button" data-toggle="modal" data-target="#modalDelete" data-url="{{ route('user.destroy', ['user' => $user->id, ]) }}" class="btn btn-xs text-danger p-0 btn-delete">
